...
│   ├── FlappyMenu            # Galaxy Glide menu + play history

│   ├── FlappyLevel           # Galaxy Glide gameplay
...
│   ├── MainMenuController.cs     # menu navigation, slots, settings

│   ├── GameManager.cs            # credit economy

│   ├── ShopManager.cs            # shop + purchase persistence

│   ├── ArcadeMachine.cs          # cabinet unlock / launch logic

│   ├── GameCompletionManager.cs  # tracks 100% completion

│   ├── FlappyGameManager.cs

│   ├── SpaceInvadersManager.cs

│   └── ...

├── Resources/

│   └── SettingsManager           # prefab auto-loaded so settings exist in every scene
